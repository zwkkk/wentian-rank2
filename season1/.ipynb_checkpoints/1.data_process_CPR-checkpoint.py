...
def read_corpus(file_path='./Multi-CPR-main/data/ecom/corpus.tsv'):
...
def make_qrels(query_dict, corpus_dict,
               qrels_file='./Multi-CPR-main/data/ecom/qrels.train.tsv',
...
if __name__ == '__main__':
    ...
    query_dict = read_corpus('./Multi-CPR-main/data/ecom/train.query.txt') # id:txt
