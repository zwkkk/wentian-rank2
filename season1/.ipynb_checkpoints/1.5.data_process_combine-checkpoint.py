...
reader_train1 = csv.reader(open('data/query_doc.csv'), delimiter='\t') 
reader_train2 = csv.reader(open('data/external_data/data/query_doc.csv'), delimiter='\t') 
reader_test1 = csv.reader(open('data/query_doc_test.csv'), delimiter='\t') 
reader_test2 = csv.reader(open('data/external_data/data/query_doc_test.csv'), delimiter='\t') 
