...
class CLTrainer(Trainer):
    def __init__(
        ...
        self.do_fgm = do_fgm
        if self.do_fgm: # FGM attack
            self.fgm = FGM(model)
        
        #if self.do_fgm:  # PGD attack
        #    self.fgm = PGD(model)
        #    self.is_first_attack=True # PGD attack
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]]) -> torch.Tensor:
        ...
        if self.do_fgm:
            ...
            self.fgm.attack(emb_name=name) # fgm
            #self.fgm.attack(emb_name=name, is_first_attack=self.is_first_attack) # pgd
            #if self.is_first_attack==True:
