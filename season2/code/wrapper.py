...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_to_convert", type=str, default='./result/bert_base_hard/models-64000', help="the checkpoint of trained model to convert")
    parser.add_argument("--output_dir", type=str, default='./model/bert_base_hard', help="the path of saved_model")
